                    ...
                    Expanded(
                        child: ImpChart(
                            ...
                            style: ChartStyle(
                                ...
                                rippleStyle: RippleAnimationStyle.prominent(color: const Color(0xFF00FFFF)),
                            ...
                            Padding(
                                ...
                                child: Column(
                                    ...
                                    children: [
                                        ...
                                        ShaderMask(
                                            shaderCallback: (bounds) => const LinearGradient(
                                                colors: [Color(0xFF00FF88), Color(0xFF00BFFF), Color(0xFFAA88FF)],
                                            ).createShader(bounds),
                                            child: const Text(
                                                '\$9,847.32',
                                                style: TextStyle(
                            ...
                            Expanded(
                                child: ImpChart(
                                    ...
                                    style: ChartStyle(
                                        ...
                                        axisStyle: AxisStyle(
                                            showGrid: true,
                                            gridColor: const Color(0xFF00FF88).withValues(alpha: 0.08),
                                        ),
                ...
                children: [
                    ...
                    Container(
                        ...
                        child: Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                                _buildStatItem('24h High', '\$3,512.40', const Color(0xFF00D084)),
                                _buildStatItem('24h Low', '\$3,298.20', const Color(0xFFFF6B6B)),
                                _buildStatItem('Volume', '892.4K', Colors.white.withValues(alpha: 0.8)),
                                _buildStatItem('Market Cap', '\$411.2B', Colors.white.withValues(alpha: 0.8)),
                            ],
                        ),
                    ),
                    // Chart
