                            ...
                            tabs: const[
                                Tab(
                                    child: Padding(
                                        ...
                                        child: Row(children: [Icon(Icons.candlestick_chart, size: 16), SizedBox(width: 8), Text('Trading')]),
                                    ),
                                ),
                                Tab(
                                    child: Padding(
                                        padding: EdgeInsets.symmetric(horizontal: 16),
                                        child: Row(children: [Icon(Icons.show_chart, size: 16), SizedBox(width: 8), Text('Simple')]),
                                    ),
                                ),
                                Tab(
                                    child: Padding(
                                        padding: EdgeInsets.symmetric(horizontal: 16),
                                        child: Row(children: [Icon(Icons.compress, size: 16), SizedBox(width: 8), Text('Compact')]),
                                    ),
                                ),
                                Tab(
                                    child: Padding(
                                        padding: EdgeInsets.symmetric(horizontal: 16),
                                        child: Row(children: [Icon(Icons.minimize, size: 16), SizedBox(width: 8), Text('Minimal')]),
                                    ),
                                ),
                            ],
                        ),
        ...
        return InkWell(
            ...
            child: AnimatedContainer(
                ...
                child: Column(
                    ...
                    children: [
                        Icon(
                            isLive ? Icons.pause_circle_filled : (isSelected ? Icons.play_circle_outline : Icons.radio_button_unchecked),
                ...
                child: Column(
                    children: [
                        Container(
                            ...
                            child: Row(
                                children: [
                                    const Icon(Icons.candlestick_chart, color: Colors.cyan, size: 16),
                                    const SizedBox(width: 8),
                                    const Text(
                                        'PRO TRADER VIEW',
                                        style: TextStyle(
                ...
                child: Column(
                    children: [
                        Container(
                            ...
                            child: Row(
                                children: [
                                    const Icon(Icons.show_chart, color: Color(0xFF00D084), size: 16),
                                    const SizedBox(width: 8),
                                    const Text(
                                        'SIMPLE LINE',
                                        style: TextStyle(
                ...
                child: Column(
                    children: [
                        Container(
                            ...
                            child: Row(
                                children: [
                                    const Icon(Icons.compress, color: Color(0xFFFFA44C), size: 16),
                                    const SizedBox(width: 8),
                                    const Text(
                                        'COMPACT OVERVIEW',
                                        style: TextStyle(
                ...
                child: Column(
                    children: [
                        Container(
                            ...
                            child: Row(
                                children: [
                                    const Icon(Icons.minimize, color: Color(0xFFFF6B6B), size: 16),
                                    const SizedBox(width: 8),
                                    const Text(
                                        'MINIMAL SPARK',
                                        style: TextStyle(
