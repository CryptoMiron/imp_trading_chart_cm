                                                ...
                                                child: Column(
                                                    ...
                                                    children: [
                                                        ...
                                                        _NavigationCard(
                                                            ...
                                                            gradientColors: const[Color(0xFF00FFFF), Color(0xFFFF00FF)],
                                                            onTap: () => Navigator.push(
                                                                context,
                                                                MaterialPageRoute(
                                                                    builder: (context) => const ChartShowcaseScreen(),
                                                                ),
                                                            ),
                                                            isNew: true,
                                                        ),
                                                        ...
                                                        _NavigationCard(
                                                            ...
                                                            onTap: () => Navigator.push(
                                                                context,
                                                                MaterialPageRoute(
                                                                    builder: (context) => const ChartExampleScreen(),
                                                                ),
                                                            ),
                                                        ),
                                                    ],
        ...
        return GestureDetector(
            ...
            child: AnimatedContainer(
                ...
                decoration: BoxDecoration(
                    ...
                    boxShadow: [
                        BoxShadow(
                            color: widget.gradientColors.first.withValues(alpha: _isPressed ? 0.3 : 0.2),
