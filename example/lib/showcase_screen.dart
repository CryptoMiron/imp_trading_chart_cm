                            ...
                            child: Row(
                                children: [
                                    ...
                                    Container(
                                        ...
                                        decoration: BoxDecoration(
                                            gradient: LinearGradient(
                                                colors: _showcaseItems[_currentPage].gradientColors.map(
                                                    (c) => c.withValues(alpha: 0.2),
                                                ).toList(),
                                            ),
                                            borderRadius: BorderRadius.circular(20),
                                            border: Border.all(
                                                color: _showcaseItems[_currentPage].gradientColors.first.withValues(alpha: 0.3),
                                            ),
                                        ),
                                        child: Text(
                                            '${_currentPage + 1} / ${_showcaseItems.length}',
                                            style: TextStyle(
                                                color: _showcaseItems[_currentPage].gradientColors.first,
                                                fontSize: 12,
                                ...
                                children: List.generate(
                                    ...
                                    (index) => GestureDetector(
                                        ...
                                        child: AnimatedContainer(
                                            ...
                                            decoration: BoxDecoration(
                                                gradient: LinearGradient(
                                                    colors: _currentPage == index ? _showcaseItems[index].gradientColors : [Colors.white.withValues(alpha: 0.2), Colors.white.withValues(alpha: 0.2)],
                                                ),
                                                borderRadius: BorderRadius.circular(5),
                                                boxShadow: _currentPage == index
                                                    ? [
                                                        BoxShadow(
                                                            color: _showcaseItems[index].gradientColors.first.withValues(alpha: 0.5),
                                                            blurRadius: 10,
                                                        ),
                                                    ]
                                                    : null,
